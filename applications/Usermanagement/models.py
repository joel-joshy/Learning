...
class User(AbstractUser, DateBaseModel):
    ...
    role = models.CharField(choices=ROLE_CHOICES, default='manager', max_length=20, blank=True, null=True)
    employee_id = models.CharField('Employee ID', max_length=50, blank=True, null=True)
    dob = models.DateField(verbose_name='Date of Birth', null=True, blank=True)
    institution = models.ForeignKey('Institution', on_delete=models.CASCADE, related_name='get_user', verbose_name="Institution", null=True)
